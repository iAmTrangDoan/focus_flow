...
import { mockTasks, type Task } from '../mockData';
      ...
      <div className="text-center">
        ...
        <button
          ...
          style={{
            background: '#5FAF6E',
            color: '#FFFFFF',
            boxShadow: '0 4px 16px rgba(95, 175, 110, 0.4)',
          }}
        >
          ...
          <>
            <div className="flex-1 text-left">
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge
                  variant={selectedTask.priority === 'high' ? 'high' : 'medium-low'}
                >
                  {selectedTask.priority === 'high' ? 'High' : 'Medium/Low'}
                </Badge>
                <span
            ...
            {availableTasks.length === 0 ? (
              ...
              availableTasks.map((task) => (
                <button
                  ...
                  style={{
                    background:
                      selectedTask?.id === task.id ? '#DDF3DF' : 'transparent',
                  }}
                  onMouseEnter={(e) => {
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge
                        variant={task.priority === 'high' ? 'high' : 'medium-low'}
                      >
...
export default function FocusSessionsPage({ onToast }: FocusSessionsPageProps) {
  ...
  const handleCancelReasonSelect = (_reason: string) => {
    setShowCancelModal(false);
    setStatus('idle');
    setTimeRemaining(getTotalTime(phase));
    onToast(createToast('warning', 'Đã ghi nhận. Phiên này được tính là 1 lần Bỏ ngang'));
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          background: 'rgba(95, 175, 110, 0.15)',
          color: '#5FAF6E',
        }}
      >
        ⏩ Kết thúc phiên (demo)
